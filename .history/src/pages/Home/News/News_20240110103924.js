...
export const News = () => {
  ...
  return (
    <div className="news-tab">
      ...
      <div className="panels col-md-11">
        ...
        <div className={`panel ${checkActive(2, "active3")}`}>
          ...
          <div className="flexy">
            ...
            <div className="col-md-3 tab-overlay">
              {" "}
              <img src={Img4} alt="sch-images" width="97%" />
            </div>{" "}
            <div className="col-md-3 tab-overlay mvt card">
              ...
              <div className="flexy flexyM ">
                <img src={Img8} alt="sch-images" width="30px" height="30px" />
                <p style={{ flex: "right" }}>July 8, 2023</p>
              </div>
            </div>
            <div className="col-md-3 ">
              {" "}
              <img src={Img5} alt="sch-images" width="97%" />
            </div>
            <div className="col-md-3 mvt card">
              {" "}
