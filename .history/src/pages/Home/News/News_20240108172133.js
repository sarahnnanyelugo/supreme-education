      ...
      <div className="panels col-md-10 offset-md-1">
        ...
        <div className={`panel ${checkActive(2, "active3")}`}>
          ...
          <div className="flexy">
            ...
            <div className="col-md-3 tab-overlay mvt">
              {" "}
              <p>
                ...
                during the academic session .#Supremecares, #iamsupremesch,
                #Bestschoolinlagos, #Bestschoolinnigeria, #Britishcurriculum,
                #Nigeriancurriculum, #Schoolsinlagos, #Schoolsinnigeria,
                #playmatters, #playbasedlearning, #earlychildhood,
                #earlychildhoodeducation, #earlylearning, #childcare,
                #learning,#eyfsideas, #childdevelopment
              </p>
            </div>
