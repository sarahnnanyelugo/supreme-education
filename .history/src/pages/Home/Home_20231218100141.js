...
export const Home = () => {
  return (
    <>
      ...
      <div className="mt flexy col-md-10 offset-md-1">
        <div className="col-md-4 explore">
          <h1>Explore Supreme Education</h1>
          <h3>Explore all Supreme facilities</h3>
        </div>
        <div className="col-md-4">
          <img src={Img9} alt="sch-images" width="100%" className="col-md-11" />
          <img
            src={Img10}
            alt="sch-images"
            width="100%"
