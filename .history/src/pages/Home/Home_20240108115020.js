  ...
  return (
    <>
      <div className="landing-images">
        ...
        <Carousel fade>
          <Carousel.Item>
            <img src={Slider1} alt="sch-images" className="car-imgs" />
            <Carousel.Caption>
              <h1>
                A Place of Care <br />
                and Excellence
          ...
          <Carousel.Item>
            <img src={Slider2} alt="sch-images" className="car-imgs" />
            <Carousel.Caption>
              <h1>
                A Place of Care <br />
                and Excellence
          ...
          <Carousel.Item>
            <img src={Slider3} alt="sch-images" className="car-imgs" />
            <Carousel.Caption>
              <h1>
                A Place of Care <br />
                and Excellence
          ...
          <Carousel.Item>
            <img src={Slider4} alt="sch-images" className="car-imgs" />
            <Carousel.Caption>
              <h1>
                A Place of Care <br />
                and Excellence
          ...
          <Carousel.Item>
            <img src={Slider5} alt="sch-images" className="car-imgs" />
            <Carousel.Caption>
              <h1>
                A Place of Care <br />
                and Excellence
