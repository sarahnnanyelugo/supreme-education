    ...
    <div className="eyfs-div">
      ...
      <div className="flexy col-md-9 offset-md-1">
        <div className="col-md-6">
          We run a blended curriculum that is centered on both the Nigerian and
          British curriculum. Hence, our students write Cambridge Checkpoint and
          BECE external examinations in Year 9. Supreme students typically
          graduate at the end of Year 12 after sitting for West African Senior
          School Certificate Examination (WASSCE)while few would proceed to A
          level schools across the globe. IGCSE and SAT are optional
          examinations.
        </div>
        <div className="col-md-6">
          {" "}
