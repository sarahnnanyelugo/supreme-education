...
import Slider2 from "../../assets/images/logos1.png";
import Slider3 from "../../assets/images/logos2.png";
...
export const SeniorSchool = () => {
  return (
    <div className="senior-div">
      ...
      <div className="col-md-10 offset-md-1 mt7 flexy inner-page-content">
        <div className="col-md-6">
          <p>
