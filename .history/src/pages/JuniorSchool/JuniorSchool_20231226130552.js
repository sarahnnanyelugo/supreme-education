  ...
  return (
    <div className="eyfs-div">
      <Banner
        ...
        mainpage="Academics"
      />
      <div className=" col-md-10 offset-md-1 mt flexy  inner-page-content">
      ...
      <div className="col-md-8 offset-md-1 mt7  inner-page-content">
        <p>
        ...
        <h3 className="mt4">Head, Junior School</h3>
        <div className="col-md-4">
          {" "}
