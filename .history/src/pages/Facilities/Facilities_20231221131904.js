      ...
      <div className=" col-md-10 offset-md-1 mt7 flexy">
        <div className=" col-md-6">
          ...
          <p>
            ...
            resources covering science and technology, humanities and the social
            sciences, there are research materials and bibliographies
        ...
        <div className="flexy">
          <ul className="list-unstyled col-md-5">
            <li>
