...
export const WhoWeAre = () => {
  return (
    <div className="about-div">
      ...
      />
      <div className="flexy  col-md-10 offset-md-1 content-div inner-page-content">
      ...
      <div className="creed col-md-10 offset-md-1 content-div inner-page-conent">
        <center>
          {" "}
      ...
      <div className="col-md-6 offset-md-1 flexy content-div inner-page-content ">
        <div className="col-md-7">
          <h1>Our School Anthem</h1>
          <h6>Anthem</h6>
          <p>
            Lord of life one voice we raise <br />
            For our dear school we give you praise. <br />
            Strength for the challenges of our days <br />
            And light to guide our path we pray. <br />
            No other foundation can be laid <br />
            Supreme Education Foundation.
          </p>
        </div>
        <div className="col-md-4 offset-md-1 mt9">
          <h6>Choros</h6>
          <p>
            Supreme!,
            <br /> Supreme! <br />
