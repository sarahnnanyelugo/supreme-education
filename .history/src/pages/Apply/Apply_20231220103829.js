      ...
      <div className="flexy col-md-10 offset-md-1">
        <div className="col-md-8">
          ...
          <h6>
            ...
            department or scanned and mailed to admissions@supremeeducation.com
            or send to WhatsApp
          </h6>
          ...
          <div className="info-corner2 mt5">
            <p>
              You can Also make payment online <Link>HERE</Link> Download Past
              Questions Complete Online form and submit. (Click here for online
              admission form)
            </p>
          </div>
        </div>
