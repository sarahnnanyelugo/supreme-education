          ...
          <div className="card">
            ...
            <div className="flexy flexyM">
              <div className="col-md-6 left">
                ...
                <hr />
                <p>Several Days November 27th - December 6th</p>
                <hr />
                <p>Several Days December 4th - December 7th</p>
                <hr />
              ...
              <div className="col-md-6 right">
                ...
                <hr /> <p>EYFS Colour Day</p>
                <hr /> <p>Christmas Light On & Thanksgiving</p>
                <hr /> <p>High School Exam</p>
                <hr /> <p>Junior School Exam</p>
                <hr /> <p>Christmas Concert</p>
                <hr /> <p>ARD/End of Term</p>
              </div>
            </div>
            <hr />
          </div>
