        ...
        <Offcanvas.Body>
          <div className="menu-body flexy">
            ...
            <div className="col-md-8">
              <nav>
                <ul>
                  <li data-role="thumb-1 " className="col-md-6">
                    <section data-role="content-1" className="col-md-6">
                      Content-1
                    </section>
                  </li>
                </ul>
                <ul>
                  <li data-role="thumb-2" className="col-md-6">
                    <section data-role="content-2" className="col-md-6">
                      Content-2
                    </section>
                  </li>
                </ul>
                <ul>
                  <li data-role="thumb-3" className="col-md-6">
                    <section data-role="content-3" className="col-md-6">
                      Content-3
                    </section>
                  </li>
                </ul>
                <ul>
                  <li data-role="thumb-4" className="col-md-6">
                    <section data-role="content-4" className="col-md-6">
                      Content-4
                    </section>
                  </li>
                </ul>
